...
class BorrowerSignUpForm(UserCreationForm):
    ...
    default_on_file = forms.BooleanField(required=False)
...
class LenderSignUpForm(UserCreationForm):
    ...
    liquid_funds = forms.FloatField(required=True, help_text='Required.')
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name', 'email', 'password1', 'password2', 'liquid_funds')